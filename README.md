...
- [moby/buildkit](https://github.com/moby/buildkit) ([v0.25.0](https://github.com/moby/buildkit/releases/tag/v0.25.0), 5 days ago) - concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit
...
- [moghtech/komodo](https://github.com/moghtech/komodo) - 🦎 a tool to build and deploy software on many servers 🦎 (3 days ago)
